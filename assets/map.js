...
//****** Problem ***********//
  // I want to change marker colors for each icon
  // I know this cause in line 142.
  // But it's inside of the object, if statement, and object.
  // So, I don't know how can I change there icon url.
  // I tried 
  //  markers[i].icon = 'http://maps.google.com/mapfiles/ms/icons/green-dot.png'
  //  google.maps.Marker.icon = 'http://maps.google.com/mapfiles/ms/icons/green-dot.png'
//****************************//
...
var markers = [];
var autocomplete;
 //***US     //var countryRestrict = {'country': 'us'};
...
function initMap() {
  ...
  autocomplete = new google.maps.places.Autocomplete(
      ...
      (document.getElementById('autocomplete')), {
        types: ['(cities)'],
//****US    componentRestrictions: countryRestrict
      });
